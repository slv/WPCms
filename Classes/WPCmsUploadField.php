...
Class WPCmsUploadField Extends WPCmsField {
  ...
  { ?>
    ...
    <input type="button" value="<?php _e('Delete File', WPCmsStatus::getStatus()->getData('textdomain')); ?>" class="button upload-file-delete"<?php if (!empty($data['value'])) echo ' style="display:none;"'; ?> />
